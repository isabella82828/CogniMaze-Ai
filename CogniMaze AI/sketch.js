...
function writeShit(){
  ...
  textSize(18);
  noStroke();
  text("Click SPACE to present the generation the A.I. belongs to", 440,590).fo;
  text(" \tPress P to play the game yourself. \t\t\t Press G to replay the evolution highlights.",370,620 );
  textSize(20);
  if(winCounter > 0){
